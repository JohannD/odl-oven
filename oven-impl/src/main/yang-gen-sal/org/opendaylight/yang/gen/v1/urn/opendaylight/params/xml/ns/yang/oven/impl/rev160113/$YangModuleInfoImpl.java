...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "oven-impl";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:oven:impl";
    private final String revision = "2016-01-13";
    private final String resourcePath = "/META-INF/yang/oven-impl.yang";
